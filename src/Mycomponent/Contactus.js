...
function contactUs(){
    return(
        <form action="/action_page.php" className="w3-container w3-card-4 w3-green w3-text-white w3-margin">
  ...
  <p className="w3-center">
    <button className="w3-button w3-section w3-blue w3-ripple" style={{width:'100px'}}> Send </button>
  </p>
</form>
